package com.gooddaytaxi.support.application.dto.input.log;
 ...
 */
@Getter
public class ErrorDetectedCommand extends Command {
    ...
    public static ErrorDetectedCommand create(
            UUID notificationOriginId, UUID notifierId,
            UUID dispatchId, UUID tripId, UUID paymentId,
            UUID driverId, UUID passengerId,
            String sourceNotificationType, String logType,
        ...
        return new ErrorDetectedCommand(notificationOriginId, notifierId, dispatchId, tripId, paymentId, driverId, passengerId, sourceNotificationType, logType, logMessage, metadata);
    }
